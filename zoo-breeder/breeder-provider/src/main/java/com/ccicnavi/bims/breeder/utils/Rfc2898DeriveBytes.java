package com.ccicnavi.bims.breeder.utils;
...
public class Rfc2898DeriveBytes {
    ...
    public Rfc2898DeriveBytes(byte[] password, byte[] salt, int iterations)throws Exception {
        this.salt = salt;
    ...
    public Rfc2898DeriveBytes(String password, int saltSize, int iterations) throws Exception {
    ...
    public Rfc2898DeriveBytes(String password, int saltSize) throws Exception,
            UnsupportedEncodingException {
        this(password, saltSize, 1000);
    }

    public Rfc2898DeriveBytes(String password, byte[] salt, int iterations) throws Exception,
