...
public class OrderInfoDTO implements Serializable {
     ...
     *取证方式
     */
    private String fetchCertType;
    /**
     *邮寄地址
     */
    private String fetchCertPostal;
    /**
     *是Y否N带标证书，默认N
     */
    private String isLabelCert;
    /**
     *是Y否N电子证书，默认N
     */
     ...
     *证书正本数量
     */
    private String certQty;
    /**
     *证书副本数量
     */
    private String certCopyQty;
    /**
     *受理日期
     */
    @JsonFormat(pattern="yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
